...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<%UserBean ub = (UserBean)request.getAttribute("userinfo");
		...
		PhotoalbumBean pab = (PhotoalbumBean)request.getAttribute("singlealbum");
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td align="left" valign="top">
								<form action="photoalbumlistdo?param=update" method="post">
									<table width="85%" border="0" align="right" cellpadding="0"
										...
										<tr>
											<td width="100%">&nbsp;&nbsp;&nbsp;&nbsp; 
												相册名称： 
												<input type="text" name="albumname" value="<%=pab.getAlbumname() %>"/>
												<br/>&nbsp;&nbsp;&nbsp;&nbsp; 相册描述： 
												<input type="text" name="albumdepict" value="<%=pab.getAlbumdepict() %>"/>
												<br />
												<input type="hidden" name="userid" value="<%=ub.getUserid() %>"/>
												<input type="hidden" name="albumid" value="<%=pab.getAlbumid() %>"/>
											</td>
										</tr>
										<tr>
