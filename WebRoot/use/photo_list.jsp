    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="top"><table width="85%" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            <td height="30"><strong class="f12_000">我的相册:<%=albumname %></strong></td>
          </tr>
          <tr>
            <td height="35"><%
					if (userid2==userid1) {
				%><input name="input" type="submit" value="上传照片" /><%} %></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <%} %>
				...
				%><a href = "photodo?param=del&photoid=<%=pb.getPhotoid()%>&userid=<%=pb.getUserid() %>">删除</a>&nbsp;&nbsp;&nbsp;
				  <a href = "photodo?param=preupdate&photoid=<%=pb.getPhotoid()%>&userid=<%=pb.getUserid() %>&albumid=<%=albumid%>">修改</a>
				  <%} %>
				  </td>
                  </tr>
                </table>
...
<table width="809" border="0" align="center" cellpadding="0" cellspacing="0" style="background:url(images/foot_bg.png) no-repeat 8px 0;">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:4px;">
      <tr>
        <td height="30" valign="middle" align="center" class="f12_000">陈巍瑜 版权所有<br /></td>
      </tr>
    </table>
