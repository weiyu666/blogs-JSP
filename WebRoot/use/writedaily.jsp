									...
									<table width="85%" border="0" align="right" cellpadding="0"
										...
										<tr>
											<td height="50" class="f12_000">
												<strong>标题</strong>
												<label>
													<input type="text" name="dailyname"
										...
										<tr>
											<td width="100%">
												<textarea name="content" id="textarea3"
													style="display: none">
												<?=$content?>
       										 </textarea>
									...
									<tr>
										<td height="300" align="left" valign="top"
											...
											<table width="70%" border="0" align="center" cellpadding="0"
												...
												<tr>
													<td height="30" class="f12_000" style="padding-left: 10px;">
														<a href="bloglistdo">返回博客系统主页</a><br />
													</td>
												</tr>
												<tr>
													<td height="30" class="f12_000" style="padding-left: 10px;">
			...
			<tr>
				<td height="92" valign="top">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<td height="25" valign="middle" align="center" class="f12_000">
								陈巍瑜 版权所有
								<br />
							</td>
						</tr>
