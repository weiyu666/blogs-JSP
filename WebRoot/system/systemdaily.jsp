...
<%@ page import="com.blog.system.Dto.DailyBean"%>
				...
				<td valign="top">
					...
					<table width="100%" border="1" cellpadding="0" cellspacing="0"
						...
						<tr align="center">
							...
							<td class="f12_408BAA">
								<a href="/blog/system/dailydo?param=del&dailyid=<%=db.getDailyid()%>">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="/blog/system/dailycdo?dailyid=<%=db.getDailyid()%>">查看</a>
							</td>
						</tr>
						<%
							}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td>
								...
								%>
										<a href="/blog/system/dailydo?page=1">首页</a>
										<a href="/blog/system/dailydo?page=<%=page1-1%>">上一页</a>
										<a href="/blog/system/dailydo?page=<%=page1+1%>">下一页</a>
										<a href="/blog/system/dailydo?page=<%=(count-1)/size+1%>">末页</a>
								</div>
							</td>
							<form id="form01" action="/blog/system/dailydo?page=">
							<td width="300" align="center" class="f12_0000">
								...
								当前<%=page1%>/<%=(count-1)/size+1%> 共<%=count%>条记录							</td>
						</tr>
					</table>
					<!--“分页器”结束-->
