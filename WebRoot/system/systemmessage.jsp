...
<%@ page import="com.blog.system.Dto.*"%>
				...
				<td valign="top">
					...
					<table width="100%" border="1" cellpadding="0" cellspacing="0"
						...
						<tr align="center">
							...
							<td class="f12_0000">
								<%String message1=mb.getMessage();
								String message2;
								if(message1.length()>10)
								message2=message1.substring(0,9);
								else message2 = message1;%>
								<%=message2 %>
							...
							<td class="f12_408BAA">
								<a href="messagedo?param=del&messageid=<%=mb.getMessageid()%>">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="messagedo?param=singlemessage&messageid=<%=mb.getMessageid()%>">查看</a>
							</td>
						</tr>
						<%
							}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<%
								...
								%>
										<a href="messagedo?page=1">首页</a>
										<a href="messagedo?page=<%=page1-1%>">上一页</a>
										<a href="messagedo?page=<%=page1+1%>">下一页</a>
										<a href="messagedo?page=<%=(count-1)/size+1%>">末页</a>
								</div>
							</td>
							<form id="form01" action="messagedo?page=">
