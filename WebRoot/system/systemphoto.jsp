...
<%@ page import="com.blog.system.Dto.PhotoBean"%>
...
<table width="918" align="center" cellpadding="0" cellspacing="0"
		...
		<table width="918" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="250" align="left" class="f12_0000"> 
				...
				<td valign="top">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="28" bgcolor="#3F80C0" class="f12_ffff"
								style="padding-left: 10px;">图片管理  
								<img src="images/iecool_arrow.gif" width="7" height="9"
									style="margin: 0 10px;" /> 图片列表 
							</td>
						</tr>
					</table>
					<!--“当前位置”结束-->
					...
					<table width="100%" border="1" cellpadding="0" cellspacing="0"
						...
						<tr align="center">
							...
							<td class="f12_408BAA">
								<a href="/blog/system/photodo?param=del&photoid=<%=pb.getPhotoid()%>">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="/blog/system/photocdo?photoid=<%=pb.getPhotoid()%>">查看</a>
							</td>
						</tr>
						<%
							}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td>
								...
								%>
										<a href="/blog/system/photodo?page=1">首页</a>
										<a href="/blog/system/photodo?page=<%=page1-1%>">上一页</a>
										<a href="/blog/system/photodo?page=<%=page1+1%>">下一页</a>
										<a href="/blog/system/photodo?page=<%=(count-1)/size+1%>">末页</a>
								</div>
							</td>
							<form id="form01" action="/blog/system/photodo?page=">
							<td width="300" align="center" class="f12_0000">
								转到第
								<input name="page" type="text" class="select2" size="3"
									style="margin: 0 5px;" />
								页
								<input type="image" src="images/go.gif" align="absmiddle"
										border="0" style="margin: 0 3px;" />
