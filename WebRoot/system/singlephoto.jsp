...
<%@ page
	import="java.text.*,java.util.*,com.blog.system.Dto.PhotoBean,java.util.Date,com.blog.system.Dto.CommentBean"%>
				...
				<td valign="top">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="25" bgcolor="#FFFEE7">
								<span class="f12_0000" style="padding-left: 10px;"><strong>图片相关信息</strong>
								</span>
							</td>
						</tr>
					</table>
					<table width="100%" border="1" cellpadding="0" cellspacing="0"
						...
						<tr align="center">
							...
							<td align="left" class="f12_0000" style="padding-left: 10px;"><%=pb.getPhotoid()%></td>
						</tr>
						<tr align="center">
							<td width="190" height="30" class="f12_484848">
								<strong>图片名</strong>
							</td>
							<td align="left" class="f12_0000" style="padding-left: 10px;"><%=pb.getPhotoname()%></td>
						</tr>
						<tr align="center">
							<td width="190" height="30" class="f12_484848">
								<strong>图片地址</strong>
							</td>
							<td align="left" class="f12_0000" style="padding-left: 10px;"><%=pb.getPhotoaddress()%></td>
						</tr>
						<tr align="center">
							<td width="190" height="30" class="f12_484848">
								<strong>图片描述</strong>
							</td>
							<td align="left" class="f12_0000" style="padding-left: 10px;"><%=pb.getPhotodepict()%></td>
						</tr>
						<tr align="center">
							<td width="190" height="30" class="f12_484848">
								<strong>图片上传时间</strong>
							</td>
							<td align="left" class="f12_0000" style="padding-left: 10px;"><%=pb.getUploadtime()%></td>
						</tr>
					</table>
					<!--“列表”结束-->
					<!--“评论列表”开始-->
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<td height="25" bgcolor="#FFFEE7">
								<span class="f12_0000" style="padding-left: 10px;"><strong>图片相关评论</strong>
								</span>
							</td>
						</tr>
					</table>
									...
									<div class="sabrosus">
										<%
											...
											int count = Integer.parseInt(request.getAttribute("count")
													.toString());
										%>
										<a href="/blog/system/photocdo?photoid=<%=pb.getPhotoid()%>&page=1">首页</a>
										<a
											href="/blog/system/photocdo?photoid=<%=pb.getPhotoid()%>&page=<%=page1 - 1%>">上一页</a>
										<a
											href="/blog/system/photocdo?photoid=<%=pb.getPhotoid()%>&page=<%=page1 + 1%>">下一页</a>
										<a
											href="/blog/system/photocdo?photoid=<%=pb.getPhotoid()%>&page=<%=(count - 1) / size + 1%>">末页</a>
									</div>
								</td>
								<form id="form01" action="/blog/system/photocdo">
								<td width="300" align="center" class="f12_0000">
									转到第
									<input name="page" type="text" class="select2" size="3"
										style="margin: 0 5px;" />
									页
									<input name="photoid" type="hidden" value="<%=pb.getPhotoid() %>"/> 
									<input type="image" src="system/images/go.gif" align="absmiddle" border="0"
											style="margin: 0 3px;" /> 当前<%=page1%>/<%=(count - 1) / size + 1%>
									共<%=count%>条记录
								</td>
								</tr>
					</table>
