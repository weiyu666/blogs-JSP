...
<%@ page
	import="java.text.*,java.util.*,com.blog.system.Dto.DailyBean,java.util.Date,com.blog.system.Dto.CommentBean"%>
        ...
        <td height="30" align="center" class="f12_0000"><a href="messagedo" target="_self">留言列表</a></td>
				...
				<td valign="top">
					...
					<table width="100%" border="1" cellpadding="0" cellspacing="0"
						...
						<%
							CommentBean cb = (CommentBean) request.getAttribute("singlecomment");
						%>
						<tr align="center">
							<td width="190" height="30" class="f12_484848">
								<strong>评论ID</strong>
							</td>
							<td align="left" class="f12_0000" style="padding-left: 10px;"><%=cb.getCommentid()%></td>
						</tr>
						<tr align="center">
							<td width="190" height="30" class="f12_484848">
								<strong>评论内容</strong>
							</td>
							<td align="left" class="f12_0000" style="padding-left: 10px;"><%=cb.getComment()%></td>
						</tr>
						<tr align="center">
							<td width="190" height="30" class="f12_484848">
								<strong>评论时间</strong>
							</td>
							<td align="left" class="f12_0000" style="padding-left: 10px;"><%=cb.getCommenttime()%></td>
						</tr>
						<tr align="center">
							<td width="190" height="30" class="f12_484848">
								<strong>被评论内容类型</strong>
							</td>
							<td align="left" class="f12_0000" style="padding-left: 10px;"><% int a = cb.getFlag();
									switch(a){
									case 0:%>
									图片
								<% 	break;
